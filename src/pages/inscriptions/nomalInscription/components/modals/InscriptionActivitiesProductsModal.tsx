  ...
  useEffect(() => {
    if (props.item) {
      ...
      props.item.first_payment_date &&
        setFirstpaymentDate(
          new Date(props.item.first_payment_date).toISOString().split("T")[0],
        );
    }
  }, [props.item]);
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Modal.Body className="max-h-[70vh] overflow-auto">
          ...
          <div className="flex mt-4 items-center">
            ...
            <div className="flex flex-grow gap-6 justify-between mt-6">
              <div>
                <ToggleSwitch
                  id={"required"}
                  checked={required}
          ...
          <div className="mt-4">
            {paymentType === "UNIQUE" ? (
              ...
              <>
                ...
                <div className="py-4">
                  ...
                  <div className="flex gap-4">
                    <div className="mt-4 w-full">
                      <Label>Selecciona cuando se hará el primer pago</Label>
                      <div className="mt-1">
                        <Select
                          value={selectedPaymentDateType}
                          onChange={(e) =>
                            setSelectedPaymentDateType(e.currentTarget.value)
                          }
                        >
                ...
                {aditionalPaymentDeadlines.length > 0
                  ? aditionalPaymentDeadlines.map((deadline, index) => (
                      <React.Fragment key={deadline.uuid}>
                        <div className="py-4">
                          <h1 className="border-b-2 pb-2">{index + 2}º pago</h1>
                          <div className="flex">
                            <div className="mt-4 mr-8 w-2/3">
                              <Label>Selecciona la fecha del pago</Label>
                              <div className="mt-1">
                                <TextInput
                                  type="date"
                            ...
                            <div className="mt-4 w-1/3 flex gap-2">
                              <div>
                ...
                <div className="mt-4">
                  <Button
                    className="text-primary flex w-full"
                    size="sm"
                    color="light"
                    onClick={handleAditionalDeadline}
                  >
                    Añadir pago
                  </Button>
                </div>
          ...
          {advancedOptions && (
            ...
            <>
              <div className="mt-8">
                <p className="font-normal text-lg">Opciones avanzadas</p>
              </div>
              <div className="border-t-2 mt-1">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 justify-between items-start mt-6">
                  <div className="sm:col-span-2 mr-4">
                    <ToggleSwitch
                      ...
                      <div className="mt-4">
                        ...
                        <div className="mt-1">
                          <TextInput
                            ...
                            onChange={(e) =>
                              changeTimeEnd(e.currentTarget.value)
                            }
                          />
                        </div>
                      </div>
