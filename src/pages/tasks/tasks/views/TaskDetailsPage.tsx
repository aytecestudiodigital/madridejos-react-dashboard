  ...
  return (
    <>
            ...
            {actualTask ? (
              <Card>
                  ...
                  <div className="flex flex-col md:flex-row gap-4">
                    <div className="w-full md:w-1/2">
                      <div className="flex">
                        ...
                        <p>
                          {actualTask.users ? actualTask.users.name : ""}{" "}
                          {actualTask.users ? actualTask.users.surname : ""}
                        </p>
                      </div>
                      <div className="flex">
                        <Label
                        ...
                        <p>
                          {new Date(actualTask.created_at).toLocaleString()}
                        </p>
                      </div>
                    ...
                    <div className="md:w-1/2 px-4 gap-4">
                        ...
                        <div className="flex">
                          ...
                          <div>
                            {actualTask.state === "CREATED" ? (
                              <div className="bg-purple-100 text-purple-800 px-2 py-0.5 rounded-full font-semibold">
                                Creada
                              </div>
                            ) : actualTask.state === "ASSIGNED" ? (
                              <div className="bg-orange-100 text-orange-800 px-2 py-0.5 rounded-full font-semibold">
                                Asignada
                              </div>
                              ...
                              <div className="bg-gray-100 text-gray-800 px-2 py-0.5 rounded-full font-semibold">
                                Cerrada
                              </div>
                            ) : null}
                          </div>
                        ...
                        <div className="flex gap-x-4">
                          ...
                          {actualTask.state === "CLOSED" ? (
                            <>
                              ...
                              <Button
                                onClick={() =>
                                  handleChangeStateButtons("VALIDATED")
                                }
                                color="success"
                              >
                                Validar
                      ...
                      <div className="mt-4">
                        ...
                        <Select
                          className="mt-1"
                          value={actualTask.priority}
                          onChange={(e) =>
                            handleChangePriority(e.currentTarget.value)
                          }
                        >
                ...
                <div className="mt-4">
                  ...
                  {technicals.length > 0 ? (
                    <>
                      ...
                      {technicals.map((tech) => (
                        ...
                        >
                          <div className="w-1/3">
                            <p>
                              {tech.users.name} {tech.users.surname}
                            </p>
                          </div>
                          <div className="w-1/3">
                    ...
                    <div className="flex items-center justify-center">
                      <p className="text-center bg-blue-200 py-2 px-4 rounded-full font-semibold">
                        No hay técnicos asignados a esta tarea
                      </p>
                    </div>
                  )}
                </div>
                <div className="mt-4">
                  ...
                  <div>
                    <h1 className="px-2">
                      <span className="font-bold">Ubicación:</span> {address}
                    </h1>
                      ...
                      <div className="px-2 py-2">
                        <Wrapper apiKey={import.meta.env.VITE_GOOGLE_MAPS}>
                          <GoogleMaps>
                            <Marker
                              position={{
                                lat: actualTask.position
                                  ? actualTask.position[0]
                                  : 39.471655,
                                lng: actualTask.position
                                  ? actualTask.position[1]
                                  : -3.533282,
                              }}
                            />
                          </GoogleMaps>
                ...
                <div className="mt-4">
                  ...
                  {actualTask.images && actualTask.images.length > 0 ? (
                    ...
                    <div className="flex justify-center items-center h-full md:mb-6">
                      <div className="flex">
                        <HiOutlineInformationCircle className="mt-1 mr-2" />
                        No hay imágenes asignadas a esta tarea
                      </div>
                    </div>
                  )}
                </div>
                <div className="mt-4">
                  ...
                  {actualTask.documents && actualTask.documents.length > 0 ? (
                    ...
                    <div className="flex justify-center items-center h-full md:mb-6">
                      <div className="flex">
                        <HiOutlineInformationCircle className="mt-1 mr-2" />
                        No hay documentos asignados a esta tarea
                      </div>
                    </div>
                  )}
                </div>
                <div className="flex">
                  <DeleteModal
                    ...
                    disableButton={!user.users_roles.rules.tasks.tasks.delete}
                  />
                </div>
              </Card>
            ) : (
            ...
            <div>
              ...
              <div className="flex flex-col md:flex-row justify-start gap-4">
                ...
                <div className="w-full md:w-1/2 flex gap-2">
                  ...
                  <div className="w-full">
                    <Label
                      color={errors.project_id && "failure"}
                      className="font-semibold"
                    >
                      Proyecto *
                    </Label>
                    <div className="mt-1">
                      <Select
                        ...
                        onChange={(e) =>
                          setProjectSelected(e.currentTarget.value)
                        }
                      >
                        <option hidden value="">
                  ...
                  {projectSelected !== "" && projectCategories.length > 0 ? (
                    <div className="w-full">
                      <Label
                        color={errors.tasks_category_id && "failure"}
                        className="font-semibold"
                      >
                        Categoría *
                      </Label>
      ...
      {isOpenTechniciansModal ? (
        <CategoryTechniciansModal
          openModal={isOpenTechniciansModal}
          closeModal={() => setIsOpenTechniciansModal(false)}
          technicians={categoryTechnicians}
          onTechniciansSelected={(data) => afterAssignTechnicians(data)}
        />
      ) : null}
    </>
  );
