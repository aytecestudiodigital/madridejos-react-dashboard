...
const flowbiteTheme: CustomFlowbiteTheme = {
  ...
  button: {
    color: {
      ...
      primary:
        "text-white bg-primary hover:bg-primary-800 focus:ring-4 focus:ring-blue-300 dark:hover:bg-primary-900 dark:focus:ring-blue-800",
    },
    inner: {
  ...
  dropdown: {
    ...
    floating: {
      ...
      base: "z-10 w-fit rounded divide-y divide-gray-300 shadow focus:outline-none",
      ...
      style: {
        ...
        auto: "border border-gray-300 bg-white text-gray-900 dark:border-none dark:bg-gray-700 dark:text-white",
      },
      target: "w-fit",
    },
