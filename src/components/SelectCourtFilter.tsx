...
export default function SelectCourtFilter(props: CourtProps) {
  ...
  const courtFilters: { title: string; id: string }[] = [];
  ...
  props.items.forEach((item) => {
    ...
    if (!titleSet.has(title)) {
      ...
      const id = item.id;
      courtFilters.push({ title: title, id: id });
      titleSet.add(title);
    }
  });
